    ...
    <div className="animate-fadeUp" style={{ background: "var(--bg)", minHeight: "100%" }}>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div style={{ fontWeight: 800, fontSize: 20 }}>Terms & Privacy</div>
        </div>
      ...
      <div style={{ padding: "0 16px" }}>
        {sections.map(([heading, body]) => (
          <div key={heading} style={{ marginBottom: 18 }}>
            <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 6, color: headingColor }}>
              {heading}
            </div>
            <div style={{ fontSize: 13, color: "var(--txt2)", lineHeight: 1.7 }}>{body}</div>
          </div>
        ))}
