  ...
  if (locked) return (
    <div className="animate-fadeUp min-h-screen flex items-center justify-center" style={{ background: "var(--bg)" }}>
      <div className="text-center px-6 py-10 max-w-sm mx-auto">
        <div
          className="flex items-center justify-center mx-auto mb-4 rounded-3xl"
  ...
  return (
    <div className="animate-fadeUp min-h-screen" style={{ background: "var(--bg)" }}>
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div
          className="flex justify-between items-center px-4 sm:px-6 lg:px-10 py-4 sm:py-5"
        ...
        >
          ...
          <div
            className="flex items-center gap-1.5 font-mono font-semibold rounded-xl px-3 py-2"
            style={{
        ...
        {/* Two-column on lg: image left, controls right */}
        <div className="flex flex-col lg:flex-row lg:gap-6 px-4 sm:px-6 lg:px-10 py-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {!user.isPermanent && (
              <div
                className="flex items-center gap-2 mb-3 rounded-xl px-3 py-2.5 text-xs"
                style={{ background: "rgba(255,184,0,.07)", border: "1px solid rgba(255,184,0,.2)", color: "#FFB800" }}
              >
            ...
            >
              ...
              {submitted && (
                ...
                >
                  ...
                  <div className="text-sm mt-1" style={{ color: "var(--txt2)" }}>+$12.50 added to your salary</div>
                </div>
              )}
            </div>
            ...
            <div className="mt-3 mb-2">
              ...
              <div className="text-[11px]" style={{ color: "var(--txt3)" }}>Drag on the image to draw a box · Select a label first</div>
            </div>
          </div>
